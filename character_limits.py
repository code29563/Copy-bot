...
def split_message(s,original_entities,limit):
    ...
    while b < len(s):
        ...
        n0 = min(limit + start, len(s)) #the index position at which the substring would be at maximal length if broken there, or the end of the string if we hit that
